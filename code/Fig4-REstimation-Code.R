...
setwd("/Users/kristinandrejko/Box/01-Research/04-COVID/School-Survey")
...
save(May_PM, file = "GitHub/data/May_PM.rData")
save(Feb_PM, file = "GitHub/data/Feb_PM.rData")
save(Aug_PM, file = "GitHub/data/Aug_PM.rData")
save(baselineR0, file = "GitHub/data/baselineR0.rData")

# 5. COMPARE TO KNOWN DATA IN PLOTS

load(file = "GitHub/data/May_PM.rData")
load(file = "GitHub/data/Feb_PM.rData")
load(file = "GitHub/data/Aug_PM.rData")
load(file = "GitHub/data/baselineR0.rData")
...
# And type = 17 (triangle) for the R0

survey_plot_dat$type <- c("16", "15", "15", "15")
View(survey_plot_dat)
...
ggsave("GitHub/output/figures/Fig4-REstimation.jpg", dpi = 600, width = 7, height = 5)
